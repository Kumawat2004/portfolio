// Fully Responsive Header.jsx for Desktop and Mobile
    ...
    <>
      ...
      >
        ...
        <div className="h-[40%] flex flex-col items-center justify-center gap-4">
          <img className="w-[100px] md:w-[120px] rounded-full border-[6px] md:border-[10px] border-gray-400/30" src={Logo} alt="Prakash Kumawat" />
